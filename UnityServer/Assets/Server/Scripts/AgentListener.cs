...
public class AgentListener : MonoBehaviour
{
    ...
    public bool bIsEdgeGapContainer = false;
    ...
    void Start()
    {
        ...
        bIsEdgeGapContainer = !string.IsNullOrEmpty(Environment.GetEnvironmentVariable("ARBITRIUM_REQUEST_ID"));

        if (!bIsEdgeGapContainer)
        {
        ...
        {
            UnityNetworkServer.Instance.Port = Int32.Parse(Environment.GetEnvironmentVariable("ARBITRIUM_PORT_GAMEPORT_EXTERNAL"));
